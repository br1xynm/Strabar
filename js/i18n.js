...
(function () {
  ...
  const DICT = {
    es: {
      ...
      "hero.eyebrow": "Pre-lanzamiento · App móvil",
      ...
      "demo.lede":
        "La app todavía no está disponible, pero puedes probar una versión simplificada de su funcionamiento aquí mismo.",
      "demo.tabTrack": "Registrar una noche",
      "demo.tabExplore": "Explorar rutas",
      ...
      "demo.exploreLede": "Explora las rutas públicas de la comunidad, fíltralas y descúbrelas sobre el mapa.",
      "demo.stopsTitle": "Paradas de la ruta",
      "demo.routeStatsTitle": "Estadísticas de la ruta",
      "demo.exploreFilterNeighborhood": "Barrio",
      "demo.exploreFilterAll": "Todos",
      "demo.exploreFilterDistance": "Distancia",
      "demo.exploreFilterDistShort": "Corta (<3 km)",
      "demo.exploreFilterDistMedium": "Media (3–5 km)",
      "demo.exploreFilterDistLong": "Larga (>5 km)",
      "demo.exploreFilterRating": "Valoración",
      "demo.exploreFilterRating45": "4,5 o más",
      "demo.exploreFilterRating40": "4,0 o más",
      "demo.exploreSort": "Ordenar por",
      "demo.exploreSortTop": "Mejor valoradas",
      "demo.exploreSortComments": "Más comentadas",
      "demo.exploreSortShort": "Más cortas",
      "demo.exploreSortLong": "Más largas",
      "demo.exploreNoResults": "Ninguna ruta coincide con estos filtros.",
      "demo.exploreRouteBy": "Ruta de",
      "demo.exploreReviews": "valoraciones",
      "demo.exploreCommentsTitle": "Comentarios",
      ...
      "footer.copyright": "© 2026 Strabar. Proyecto en fase de pre-lanzamiento.",
    ...
    ca: {
      ...
      "hero.eyebrow": "Pre-llançament · App mòbil",
      ...
      "demo.lede":
        "L'app encara no està disponible, però pots provar una versió simplificada del seu funcionament aquí mateix.",
      "demo.tabTrack": "Registrar una nit",
      "demo.tabExplore": "Explorar rutes",
      ...
      "demo.exploreLede": "Explora les rutes públiques de la comunitat, filtra-les i descobreix-les sobre el mapa.",
      "demo.stopsTitle": "Parades de la ruta",
      "demo.routeStatsTitle": "Estadístiques de la ruta",
      "demo.exploreFilterNeighborhood": "Barri",
      "demo.exploreFilterAll": "Tots",
      "demo.exploreFilterDistance": "Distància",
      "demo.exploreFilterDistShort": "Curta (<3 km)",
      "demo.exploreFilterDistMedium": "Mitjana (3–5 km)",
      "demo.exploreFilterDistLong": "Llarga (>5 km)",
      "demo.exploreFilterRating": "Valoració",
      "demo.exploreFilterRating45": "4,5 o més",
      "demo.exploreFilterRating40": "4,0 o més",
      "demo.exploreSort": "Ordenar per",
      "demo.exploreSortTop": "Més valorades",
      "demo.exploreSortComments": "Més comentades",
      "demo.exploreSortShort": "Més curtes",
      "demo.exploreSortLong": "Més llargues",
      "demo.exploreNoResults": "Cap ruta coincideix amb aquests filtres.",
      "demo.exploreRouteBy": "Ruta de",
      "demo.exploreReviews": "valoracions",
      "demo.exploreCommentsTitle": "Comentaris",
      ...
      "footer.copyright": "© 2026 Strabar. Projecte en fase de pre-llançament.",
    ...
    en: {
      ...
      "hero.eyebrow": "Pre-launch · Mobile app",
      ...
      "demo.lede":
        "The app isn't live yet, but you can try a simplified version of how it works right here.",
      "demo.tabTrack": "Track a night",
      "demo.tabExplore": "Explore routes",
      ...
      "demo.exploreLede": "Browse the community's public routes, filter them, and see them drawn on the map.",
      "demo.stopsTitle": "Route stops",
      "demo.routeStatsTitle": "Route stats",
      "demo.exploreFilterNeighborhood": "Neighbourhood",
      "demo.exploreFilterAll": "All",
      "demo.exploreFilterDistance": "Distance",
      "demo.exploreFilterDistShort": "Short (<3 km)",
      "demo.exploreFilterDistMedium": "Medium (3–5 km)",
      "demo.exploreFilterDistLong": "Long (>5 km)",
      "demo.exploreFilterRating": "Rating",
      "demo.exploreFilterRating45": "4.5 & up",
      "demo.exploreFilterRating40": "4.0 & up",
      "demo.exploreSort": "Sort by",
      "demo.exploreSortTop": "Top rated",
      "demo.exploreSortComments": "Most commented",
      "demo.exploreSortShort": "Shortest",
      "demo.exploreSortLong": "Longest",
      "demo.exploreNoResults": "No routes match these filters.",
      "demo.exploreRouteBy": "Route by",
      "demo.exploreReviews": "reviews",
      "demo.exploreCommentsTitle": "Comments",
      ...
      "footer.copyright": "© 2026 Strabar. Project in pre-launch stage.",
