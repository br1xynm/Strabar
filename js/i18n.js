...
(function () {
  ...
  const DICT = {
    es: {
      ...
      "demo.exploreLede": "Elige una ruta popular de ejemplo y descubre sus paradas.",
    ...
    ca: {
      ...
      "demo.exploreLede": "Tria una ruta popular d'exemple i descobreix les seves parades.",
    ...
    en: {
      ...
      "demo.exploreLede": "Pick a sample popular route and see its stops.",
