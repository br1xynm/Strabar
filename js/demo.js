/* ==========================================================================
   ...
   "Track a night" — simulates start → GPS tracking → +beer stops → finish → share.
   The "See friends" tab is a static, non-interactive map illustration and
   needs no JS of its own — see index.html.
   ========================================================================== */
